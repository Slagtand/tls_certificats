- [Servidor ldap segur](#servidor-ldap-segur)
  ...
  * [Configuracions per TLS](#configuracions-per-tls)
    + [Configuració del server](#configuració-del-server)
    + [Configuració del client](#configuració-del-client)
  * [Comprovacions](#comprovacions)
- [OpenVPN amb certificats propis](#openvpn-amb-certificats-propis)
  * [Generaració de claus al servidor](#generaració-de-claus-al-servidor)
    + [Creació CA](#creació-ca-1)
    + [Generació clau del servidor i request per la CA](#generació-clau-del-servidor-i-request-per-la-ca)
    + [Creació i certificació de CA externa](#creació-i-certificació-de-ca-externa)
  * [Generació de claus al client](#generació-de-claus-al-client)
    + [Generació de clau client i request per la CA](#generació-de-clau-client-i-request-per-la-ca)
    + [Certificació de CA externa](#certificació-de-ca-externa)
  * [Configuració vpn i arrencada servidor](#configuració-vpn-i-arrencada-servidor)
  * [Configuració vpn i arrencada client](#configuració-vpn-i-arrencada-client)
